...
import com.lh.bot.platform.huobi.response.Account;
import com.lh.bot.platform.huobi.response.Accounts;
import com.lh.bot.platform.huobi.response.AccountsResponse;
import com.lh.bot.platform.huobi.response.ApiResponse;
import com.lh.bot.platform.huobi.response.Balance;
import com.lh.bot.platform.huobi.response.BalanceResponse;
import com.lh.bot.platform.huobi.response.Batchcancel;
import com.lh.bot.platform.huobi.response.BatchcancelBean;
import com.lh.bot.platform.huobi.response.BatchcancelResponse;
import com.lh.bot.platform.huobi.response.CurrencysResponse;
import com.lh.bot.platform.huobi.response.Depth;
import com.lh.bot.platform.huobi.response.DepthResponse;
import com.lh.bot.platform.huobi.response.DetailResponse;
import com.lh.bot.platform.huobi.response.Details;
import com.lh.bot.platform.huobi.response.HistoryTradeResponse;
import com.lh.bot.platform.huobi.response.IntrustDetail;
import com.lh.bot.platform.huobi.response.IntrustDetailResponse;
import com.lh.bot.platform.huobi.response.Kline;
import com.lh.bot.platform.huobi.response.KlineResponse;
import com.lh.bot.platform.huobi.response.MatchresultsOrdersDetailResponse;
import com.lh.bot.platform.huobi.response.Merged;
import com.lh.bot.platform.huobi.response.MergedResponse;
import com.lh.bot.platform.huobi.response.OrdersDetailResponse;
import com.lh.bot.platform.huobi.response.SubmitcancelResponse;
import com.lh.bot.platform.huobi.response.Symbol;
import com.lh.bot.platform.huobi.response.Symbols;
import com.lh.bot.platform.huobi.response.SymbolsResponse;
import com.lh.bot.platform.huobi.response.TimestampResponse;
import com.lh.bot.platform.huobi.response.TradeResponse;
